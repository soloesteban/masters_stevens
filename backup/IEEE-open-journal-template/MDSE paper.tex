...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{a1.png}}]{Dr. Dinesh Verma} (PhD, Stevens Institute of Technology) and all authors may include 
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{a2.png}}]{Esteban M. Solorzano Zeledon} was born in San Jose, Costa Rica, in 
