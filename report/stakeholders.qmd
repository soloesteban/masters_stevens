...
Stakeholders View of the Medical Device Knowledge Repository
:::

@fig-stakeholders_diagram depicts a SysML block definition diagram (bdd) centered on a block named “Knowledge Repository” which represents a medical device systems engineering knowledge repository. The diagram showcases various stakeholders that have an interest in this repository.
