...
@fig-stakeholders_diagram depicts a SysML block definition diagram (bdd) centered on a block named “Knowledge Repository” which represents the MedSE knowledge repository. The diagram showcases various stakeholders that have an interest in this repository.
