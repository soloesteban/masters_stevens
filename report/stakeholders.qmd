...
MDSE-KR Stakeholders View 
:::

@fig-stakeholders_diagram depicts a SysML block definition diagram (bdd) centered on a block named “Knowledge Repository” which represents the MDSE-KR. The diagram showcases various stakeholders that have an interest in the system.
