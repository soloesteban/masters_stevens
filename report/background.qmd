...
On their day to day, Medical device Systems Engineers (MDSE) interact with internal and external stakeholders.

### Internal stakeholders

Some of the internal stakeholders that MDSEs interact with are:

-   Bioinformatics: These disciplines involve the use of computational tools and biological data to develop technologies and software for managing biological information, genomics, and drug development.
-   Biotechnology
...
-   Computer Science: With the advancement of medical technology, software engineers and computer scientists are essential in developing the software that operates medical devices, manages patient data, and enables communication between different systems.
-   Supply Engineering
-   Systems Engineering
...
-->
```
Some of the external stakeholders that MDSEs interact with are:
...
-->
```
Chris Unger (Chief Systems Engineer, GE Healthcare, ESEP) presented to the INCOSE Healthcare Working group key points that makes medical device systems engineering from the rest of the systems engineering:
...
-   Rapid technology evolution is impacting development and delivery
    -   Artificial Intelligence (AI), Internet of Things (IoT), product variants, Mobile Medical Apps, complex deployment models, cloud.
