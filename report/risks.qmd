...
-->
```
The following business risks were identified for medical device companies that can be mitigated with medical device systems engineering. The risks were consulted from the Boston Scientific [@bostonsa] and Abbot [@secfili2024] 10-k forms submitted to the U.s. Securities and Exchange Comission (SEC):
