...
This is the report of the Medical Device Systems Engineering Knowledge Repository (MDSE-KR). The report was written in markdown (a markup language) using the Visual Studio IDE, it was rendered in Quarto to publish html and PDF outputs. This report can be easily re-generated, maintained, transferrable and even upgraded.